...
export default class CalculatorDisplay extends Component {
    render() {
        ...
        return (
            ...
            >
                <div
                    id="history" className="w-full min-h-[64px] py-5 px-6 text-yellow-500 text-right break-all"
                >
                    {history}
                </div>
                <div
                    id="display" className="w-full py-5 px-6 text-5xl text-white font-thin text-right break-all"
                >
                    {display}
                </div>
            </div>
